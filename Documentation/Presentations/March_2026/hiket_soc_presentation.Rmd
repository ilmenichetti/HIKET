...
But **different organic materials respond differently to temperature changes**. Thermodynamic theory predicts the more stable the material, the more it responds to temperature.

Organic matter is a chemical blob of many molecules, and since the composition of this blob changes with decomposition, also **its temperature sensitivity is likely changing while decomposition proceeds**. Yasso15 and 20 represnts this with different temperature response functions by pool, but there are also other approaches.
