...
#
# TP2 calibration with transient pre-initialization (1917 pre-run).
# Structurally identical to run_TP2_calibration.R with these changes:
#
#   1. Sources calibration_engine_transient.R (adds transient_init flag).
#   2. Sources tp2_wrapper_transient.R (adds tp2_transient_init).
...
#   6. steady_state_tp2_engine wraps tp2_transient_init (not tp2_steady_state).
...
# =============================================================================
# Identical to run_TP2_calibration.R. sigma_init stays log-transformed and
...
param_spec <- list(
  ...
  list(names = c("sigma_input", "sigma_init"), type = "flux_pair",
       window = TP2_INPUT_FLUX_WINDOW, J_bar = 1.0)
)
...
message(sprintf("flux_pair J_bar = %.3f tC/ha/yr | sigma_input window [%.3f, %.3f]",
                J_bar, TP2_INPUT_FLUX_WINDOW[1] / J_bar, TP2_INPUT_FLUX_WINDOW[2] / J_bar))
...
# =============================================================================
# CHANGED: steady_state_tp2_engine now wraps tp2_transient_init instead of
# tp2_steady_state. Engine interface is identical; the pre-run is hidden inside.
...
# CHANGED: tp2_transient_init replaces tp2_steady_state
...
message("=============================================================\n")
message("Next: run_TP2_transient_predictive.R with RUN_ID=", RUN_ID)
