...
\texttt{HIKET\_SIGMA\_1985\_INFL} & \textbf{1.0} & superseded by $\tau_C$ \\
...
\paragraph{Why the 1985 inflation is removed.} \texttt{SIGMA\_1985\_INFL} = 2.0 was a
crude device for ``1985 is less trustworthy''. $\tau_C$ now does that job explicitly
and with a stated magnitude. Keeping both would double-count.

\begin{warnbox}[This run changes three things at once]
Correlation on, tails off, 1985 inflation off. It is therefore a comparison of
