...
rate check is independent of the equilibrium confound: the pre-run currently demands
$+0.37$ to $+0.40$\,tC\,ha$^{-1}$\,yr$^{-1}$ sustained across 68 years for five of six
models, against an observed modern rate of $+0.259$ that they already overshoot.
...
constraint about 12\% tighter than the 1985 inflation it replaces. If
