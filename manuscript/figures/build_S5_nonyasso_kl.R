...
mtext("KL by parameter, simple models -- same picture as the Yassos: sigma_input dominates; SP1's alpha is the one strongly identified rate; note y-axes differ",
