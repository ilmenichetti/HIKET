...
plot(D$mrt, D$rel, type="n", xlab="intrinsic MTT of the draw (yr)",
...
mtext("(a) response against bulk MTT", 3, line=1.0, adj=0, font=2, cex=.95)
...
wl("\\hline")
wl("Model & source of the & MTT & $\\sigma_{\\mathrm{input}}$ & eff.\\ flux & misfit \\\\")
