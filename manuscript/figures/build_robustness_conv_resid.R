...
png("manuscript/figures/R1_convergence.png", width=10, height=4.6, units="in", res=200)
...
dev.off(); cat("wrote R1_convergence.png\n")
...
png("manuscript/figures/R2_residuals.png", width=12, height=4.2, units="in", res=200)
...
dev.off(); cat("wrote R2_residuals.png\n")
