...
The calibration set is $520$ permanent forest plots drawn from the Finnish
...
$250$~Mg\,ha$^{-1}$ in any campaign (see below). A fixed $20\%$ of the
...
All six models see exactly the same inputs: the same $520$ plots, the same
