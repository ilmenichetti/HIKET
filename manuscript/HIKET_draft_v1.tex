...
% RESOLVED 2026-09-21. Source confirmed by LUKE Data Support (O. Hakuni, 2026-09-14, via
% O.-P. Tikkasalo): FMI's gridded daily weather observations, bought from FMI and mirrored
% daily into LUKE's weather database (lukedb2prod). Two grids exist there (10 km and 1 km);
% OUR file is the 10 km one -- x_weather/y_weather are YKJ cell centres at ...5000 with a
% uniform 10 000 m spacing (checked on the NetCDF). The "modification" is only the
% nearest-cell extraction at the 2707 plot coordinates (global attribute
% extraction_method = "nearest_neighbour"). FMI's own citation guidance for the daily
% gridded observations is Aalto, Pirinen & Jylha 2016; the 2016 paper describes 1961-2010
% and seven variables, the operational product extends it and adds global radiation.
...
the present. The grids were obtained through the weather database of the Natural
