...
% NOTE: now IMPLEMENTED as a methods choice (see M&M "Physically-bounded input
% priors" + Appendix~\ref{app:input-bounds}); this Outlook beat may collapse into
% a forward-looking sentence on the belowground/history extension once the
% production re-run lands.
Cross-ref: Appendix~\ref{app:input-bounds}.
