...
\paragraph{And the covariate is the same in all six.} What the models miss is tracked by stand basal
area --- a productivity proxy, not a kinetic one. Because this evidence does not ride the ridge, it
is genuinely independent of everything above: the limitation is on the input side.
